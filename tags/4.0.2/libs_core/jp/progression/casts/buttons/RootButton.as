...
package jp.progression.casts.buttons {
	...
	/**
	 * <span lang="ja">RootButton クラスは、現在のシーン構造も最も上に位置するルートシーンに移動するボタン機能を提供するコンポーネントクラスです。
	...
	public class RootButton extends ButtonBase {
		...
		override public function toString():String {
			return ObjectUtil.formatToString( this, super.className, super.id ? "id" : null, "managerId" );
		}
