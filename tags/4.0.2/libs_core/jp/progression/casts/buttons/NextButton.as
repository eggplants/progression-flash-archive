...
package jp.progression.casts.buttons {
	...
	/**
	 * <span lang="ja">NextButton クラスは、現在のシーン位置を基準として次のシーンに相当する対象に移動するボタン機能を提供するコンポーネントクラスです。
	...
	public class NextButton extends ButtonBase {
		...
		override public function toString():String {
			return ObjectUtil.formatToString( this, super.className, super.id ? "id" : null, "managerId", "useTurnBack", "useRightKey" );
		}
