...
package jp.progression.casts.buttons {
	...
	/**
	 * <span lang="ja">NextButton クラスは、現在のシーン位置を基準として親のシーンに相当する対象に移動するボタン機能を提供するコンポーネントクラスです。
	...
	public class ParentButton extends ButtonBase {
		...
		public function set managerId( value:String ):void {
			...
			else if ( value && PackageInfo.hasDebugger ) {
		...
		/**
		 * <span lang="ja">新しい ParentButton インスタンスを作成します。</span>
		 * <span lang="en">Creates a new ParentButton object.</span>
		 * 
		 * @param initObject
		...
		override public function toString():String {
			return ObjectUtil.formatToString( this, super.className, super.id ? "id" : null, "managerId", "useTopKey" );
		}
