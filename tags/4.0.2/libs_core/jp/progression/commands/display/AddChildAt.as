...
package jp.progression.commands.display {
	 ...
	 * 
	 * // AddChildAt インスタンスを作成する
	 * var com:AddChildAt = new AddChildAt( container, child, 0 );
	 * 
	 * // コマンドを実行する
	 * com.execute();
	 * </listing>
	...
	public class AddChildAt extends AddChild {
		 ...
		 * <span lang="en"></span>
		 */
		public function AddChildAt( containerRefOrId:*, childRefOrId:*, index:int, initObject:Object = null ) {
			// 引数を設定する
			_index = index;
		...
		override internal function _addChildRef():void {
			// 表示リストに追加する
			_containerRef.addChildAt( _childRef, _index );
		}
		...
		override public function clone():Command {
			return new AddChildAt( super.container, super.child, _index, this );
		}
