...
package jp.progression.commands.managers {
	...
	/**
	 * <span lang="ja">Goto クラスは、指定されたシーン識別子の示すシーンに移動するコマンドクラスです。</span>
	 * <span lang="en"></span>
	 * 
	...
	public class Goto extends Command {
		...
		/**
		 * <span lang="ja">実行中の移動シーケンスを停止して、強制的に新しい移動シーケンスを実行するかどうかを取得または設定します。
		 * コマンド実行中に値を変更しても、処理に対して反映されません。</span>
		 * <span lang="en"></span>
		 */
		public function get enforced():Boolean { return _enforced; }
		public function set enforced( value:Boolean ):void { _enforced = value; }
		 ...
		 * <span lang="en"></span>
		 * @param enforced
		 * <span lang="ja">実行中の移動シーケンスを停止して、強制的に新しい移動シーケンスを実行するかです。</span>
		 * <span lang="en"></span>
		 * @param initObject
		...
		override public function toString():String {
			return ObjectUtil.formatToString( this, super.className, super.id ? "id" : null, "sceneId", "enforced" );
		}
	}
}
