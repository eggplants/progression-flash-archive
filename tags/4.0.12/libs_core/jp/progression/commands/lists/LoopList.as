...
package jp.progression.commands.lists {
	...
	/**
	 * <span lang="ja">LoopList クラスは、登録された複数のコマンドを 1 つづつ順番に実行する処理を、指定された回数繰り返して実行していくコマンドリストクラスです。</span>
	 * <span lang="en"></span>
	 * 
	...
	public class LoopList extends SerialList implements IRepeatable {
		...
		/**
		 * <span lang="ja">新しい LoopList インスタンスを作成します。</span>
		 * <span lang="en">Creates a new LoopList object.</span>
		 * 
		 * @param repeatCount
		...
		/**
		 * <span lang="ja">LoopList インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</span>
		 * <span lang="en">Duplicates an instance of an LoopList subclass.</span>
		 * 
		 * @return
		 * <span lang="ja">元のオブジェクトと同じプロパティ値を含む新しい LoopList インスタンスです。</span>
		 * <span lang="en">A new LoopList object that is identical to the original.</span>
		 */
