...
package jp.progression.config {
	 ...
	 * </listing>
	 */
	public final class WebConfig extends Configuration implements IWebConfig {
		...
		public function WebConfig( activatedLicenseType:String = null, useSWFWheel:Boolean = true, useSWFSize:Boolean = true, useHTMLInjection:Boolean = false, executor:Class = null, toolTipRenderer:Class = null ) {
			...
			// 親クラスを初期化する
			super( activatedLicenseType, WebInitializer, WebSynchronizer, WebHistoryManager, executor || CommandExecutor, WebKeyboardMapper, WebContextMenuBuilder, toolTipRenderer || ToolTip, WebDataHolder );
