...
package jp.progression.casts {
	...
	/**
	 * <span lang="ja">CastTextField クラスは、ExTextField クラスの基本機能を拡張し、イベントフローとの連携機能を実装した jp.progression パッケージで使用される基本的な表示オブジェクトクラスです。</span>
	 * <span lang="en"></span>
	 * 
	 ...
	 * </listing>
	 */
	public class CastTextField extends ExTextField implements ICastObject, IManageable {
		
		/**
		 * <span lang="ja">自身の参照を取得します。</span>
		 * <span lang="en"></span>
		 */
		public function get self():CastTextField { return CastTextField( this ); }
		...
		/**
		 * <span lang="ja">新しい CastTextField インスタンスを作成します。</span>
		 * <span lang="en">Creates a new CastTextField object.</span>
		 * 
		 * @param initObject
		...
		private static function _addedToStage( e:Event ):void {
			...
			// 実装する
			var target:CastTextField = e.target as CastTextField;
