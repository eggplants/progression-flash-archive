...
package jp.progression.casts {
	 ...
	 * </listing>
	 */
	public class CastSprite extends ExSprite implements ICastObject, IManageable {
		
		/**
		 * <span lang="ja">自身の参照を取得します。</span>
		 * <span lang="en"></span>
		 */
		public function get self():CastSprite { return CastSprite( this ); }
		...
		private static function _addedToStage( e:Event ):void {
			...
			// 実装する
			var target:CastSprite = e.target as CastSprite;
