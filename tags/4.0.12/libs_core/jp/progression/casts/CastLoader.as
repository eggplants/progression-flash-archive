...
package jp.progression.casts {
	 ...
	 * </listing>
	 */
	public class CastLoader extends ExLoader implements ICastObject, IManageable {
		
		/**
		 * <span lang="ja">自身の参照を取得します。</span>
		 * <span lang="en"></span>
		 */
		public function get self():CastLoader { return CastLoader( this ); }
		...
		private static function _addedToStage( e:Event ):void {
			...
			// 実装する
			var target:CastLoader = e.target as CastLoader;
