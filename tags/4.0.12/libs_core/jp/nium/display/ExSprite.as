...
package jp.nium.display {
	...
	/**
	 * <span lang="ja">ExSprite クラスは、Sprite クラスの基本機能を拡張した jp.nium パッケージで使用される基本的な表示オブジェクトクラスです。</span>
	 * <span lang="en">ExSprite class is a basic display object class used at jp.nium package which extends the basic function of Sprite class.</span>
	 * 
	 ...
	 * </listing>
	 */
	public class ExSprite extends Sprite implements IDisplayObjectContainer, IExDisplayObjectContainer, IIdGroup {
		...
		/**
		 * <span lang="ja">新しい ExSprite インスタンスを作成します。</span>
		 * <span lang="en">Creates a new ExSprite object.</span>
		 * 
		 * @param initObject
