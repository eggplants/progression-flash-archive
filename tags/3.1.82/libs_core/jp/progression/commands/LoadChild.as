...
package jp.progression.commands {
	...
	/**
	 * <span lang="ja">LoadChild クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに request プロパティに設定された外部 SWF ファイルを読み込んで追加するコマンドクラスです。
	...
	public class LoadChild extends Command {
		...
		/**
		 * <span lang="ja">この LoadChild オブジェクトに関係した CastLoader オブジェクトです。</span>
		 * <span lang="en"></span>
		 */
		...
		/**
		 * <span lang="ja">新しい LoadChild インスタンスを作成します。</span>
		 * <span lang="en">Creates a new LoadChild object.</span>
		 * 
		 * @param container
		...
		/**
		 * <span lang="ja">LoadChild インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</span>
		 * <span lang="en">Duplicates an instance of an LoadChild subclass.</span>
		 * 
		 * @return
		 * <span lang="ja">元のオブジェクトと同じプロパティ値を含む新しい LoadChild インスタンスです。</span>
		 * <span lang="en">A new LoadChild object that is identical to the original.</span>
		 */
