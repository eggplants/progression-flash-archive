...
package jp.progression.commands {
	...
	/**
	 * <span lang="ja">AddChild クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに DisplayObject インスタンスを追加するコマンドクラスです。
	...
	public class AddChild extends Command {
		 ...
		 * <span lang="en"></span>
		 */
		public function AddChild( container:DisplayObjectContainer, child:*, initObject:Object = null ) {
			// 引数を設定する
		...
		public override function clone():Command {
			return new AddChild( _container, _child, this ).setProperties( {
