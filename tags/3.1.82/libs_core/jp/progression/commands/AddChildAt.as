...
package jp.progression.commands {
	...
	/**
	 * <span lang="ja">AddChildAt クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに DisplayObject インスタンスを追加するコマンドクラスです。
	 ...
	 * 
	 * // AddChildAt コマンドを作成します。
	 * var com:AddChildAt = new AddChildAt( container, child, 100 );
	 * 
	 * // AddChildAt コマンドを実行します。
	 * com.execute();
	 * 
	 * // 結果を出力します。
	 ...
	 * </listing>
	 */
	public class AddChildAt extends Command {
		...
		/**
		 * <span lang="ja">新しい AddChildAt インスタンスを作成します。</span>
		 * <span lang="en">Creates a new AddChildAt object.</span>
		 * 
		 * @param container
		 ...
		 * <span lang="en"></span>
		 */
		public function AddChildAt( container:DisplayObjectContainer, child:*, index:int, initObject:Object = null ) {
			// 引数を設定する
		...
		/**
		 * <span lang="ja">AddChildAt インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</span>
		 * <span lang="en">Duplicates an instance of an AddChildAt subclass.</span>
		 * 
		 * @return
		 * <span lang="ja">元のオブジェクトと同じプロパティ値を含む新しい AddChildAt インスタンスです。</span>
		 * <span lang="en">A new AddChildAt object that is identical to the original.</span>
		 */
		public override function clone():Command {
			return new AddChildAt( _container, _child, _index, this ).setProperties( {
