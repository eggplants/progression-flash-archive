...
package jp.progression {
	...
	public class Progression extends EventIntegrator {
		 ...
		 * <span lang="en"></span>
		 */
		public static const VERSION:Version = new Version( "3.1.82" );
		...
		public function Progression( id:String, stage:Stage = null, rootClass:Class = null ) {
			...
			_activatedLicenseType ||= ProgressionActivatedLicenseType.BASIC_LIBRARY_LICENSE;
		...
		public static function initialize( activatedLicenseType:String ):Boolean {
			...
			switch( activatedLicenseType ) {
				...
				case ProgressionActivatedLicenseType.BUSINESS_WEB_LICENSE			:
				case ProgressionActivatedLicenseType.BASIC_LIBRARY_LICENSE			: { _activatedLicenseType = activatedLicenseType; break; }
