...
package jp.progression.casts {
	 ...
	 * 	trace( "CastMovieClip で CastEvent.CAST_ADDED イベントが送出されました。" );
	 * };
	 * cast.onCastRemoved = function():void {
	 * 	trace( "CastMovieClip で CastEvent.CAST_REMOVED イベントが送出されました。" );
	 * };
	 * 
	 ...
	 * </listing>
	 */
	public class CastMovieClip extends ExMovieClip implements ICastObject {
