...
package jp.progression.casts {
	...
	/**
	 * <span lang="ja">CastBitmap クラスは、ExBitmap クラスの基本機能を拡張し、イベントフローとの連携機能を実装した jp.progression パッケージで使用される基本的な表示オブジェクトクラスです。</span>
	 * <span lang="en"></span>
	 * 
	 * @example <listing version="3.0" >
	 * // CastBitmap を作成する
	 * var cast:CastBitmap = new CastBitmap( new BitmapData( 100, 100 ) );
	 * cast.onCastAdded = function():void {
	 * 	trace( "CastBitmap で CastEvent.CAST_ADDED イベントが送出されました。" );
	 * };
	 * cast.onCastRemoved = function():void {
	 * 	trace( "CastBitmap で CastEvent.CAST_REMOVED イベントが送出されました。" );
	 * };
	 * 
	 ...
	 * </listing>
	 */
	public class CastBitmap extends ExBitmap implements ICastObject {
		...
		/**
		 * <span lang="ja">新しい CastBitmap インスタンスを作成します。</span>
		 * <span lang="en">Creates a new CastBitmap object.</span>
		 * 
		 * @param bitmapData
