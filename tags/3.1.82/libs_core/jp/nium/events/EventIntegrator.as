...
package jp.nium.events {
	...
	public class EventIntegrator extends EventDispatcher implements IEventIntegrator {
		 ...
		 * 
		 * @param integrator
		 * <span lang="ja">EventIntegrator インスタンスに送出されるイベントのターゲットオブジェクトです。</span>
		 * <span lang="en">The target object for events dispatched to the EventIntegrator object.</span>
		 */
