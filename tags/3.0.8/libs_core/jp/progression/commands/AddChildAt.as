...
package jp.progression.commands {
	...
	/*======================================================================*//**
	 * <p>AddChildAt クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに DisplayObject インスタンスを追加するコマンドクラスです。
	...
	public class AddChildAt extends Command {
		...
		/*======================================================================*//**
		 * <p>新しい AddChildAt インスタンスを作成します。</p>
		 * <p>Creates a new AddChildAt object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 ...
		 * 	<p></p>
		 */
		public function AddChildAt( container:DisplayObjectContainer = null, child:* = null, index:int = 0, initObject:Object = null ) {
			// 引数を設定する
		...
		/*======================================================================*//**
		 * <p>AddChildAt インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</p>
		 * <p>Duplicates an instance of an AddChildAt subclass.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 * @return
		 * 	<p>元のオブジェクトと同じプロパティ値を含む新しい AddChildAt インスタンスです。</p>
		 * 	<p>A new AddChildAt object that is identical to the original.</p>
		 */
