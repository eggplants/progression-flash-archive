...
package jp.progression.commands {
	...
	/*======================================================================*//**
	 * <p>AddChild クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに DisplayObject インスタンスを追加するコマンドクラスです。
	...
	public class AddChild extends Command {
		 ...
		 * 	<p></p>
		 */
		public function AddChild( container:DisplayObjectContainer = null, child:* = null, initObject:Object = null ) {
			// 引数を設定する
