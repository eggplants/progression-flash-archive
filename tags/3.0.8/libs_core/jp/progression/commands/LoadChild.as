...
package jp.progression.commands {
	...
	/*======================================================================*//**
	 * <p>LoadChild クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに request プロパティに設定された外部 SWF ファイルを読み込んで追加するコマンドクラスです。
	 ...
	 * </listing>
	 */
	public class LoadChild extends Command {
		...
		/*======================================================================*//**
		 * <p>この LoadChild オブジェクトに関係した CastLoader オブジェクトです。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		...
		/*======================================================================*//**
		 * <p>新しい LoadChild インスタンスを作成します。</p>
		 * <p>Creates a new LoadChild object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 ...
		 * 	<p></p>
		 */
		public function LoadChild( container:DisplayObjectContainer = null, request:URLRequest = null, initObject:Object = null ) {
			// 引数を設定する
		...
		/*======================================================================*//**
		 * <p>LoadChild インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</p>
		 * <p>Duplicates an instance of an LoadChild subclass.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 * @return
		 * 	<p>元のオブジェクトと同じプロパティ値を含む新しい LoadChild インスタンスです。</p>
		 * 	<p>A new LoadChild object that is identical to the original.</p>
		 */
		public override function clone():Command {
			return new LoadChild( _container, _request, this ).setProperties( {
