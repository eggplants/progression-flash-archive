...
package jp.progression.commands {
	...
	/*======================================================================*//**
	 * <p>LoadChildAtAbove クラスは、対象の DisplayObjectContainer インスタンスのディスプレイリストに request プロパティに設定された外部 SWF ファイルを読み込んで追加するコマンドクラスです。
	...
	public class LoadChildAtAbove extends Command {
		...
		/*======================================================================*//**
		 * <p>この LoadChildAtAbove オブジェクトに関係した CastLoader オブジェクトです。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		...
		/*======================================================================*//**
		 * <p>新しい LoadChildAtAbove インスタンスを作成します。</p>
		 * <p>Creates a new LoadChildAtAbove object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 ...
		 * 	<p></p>
		 */
		public function LoadChildAtAbove( container:DisplayObjectContainer = null, request:URLRequest = null, index:int = 0, initObject:Object = null ) {
			// 引数を設定する
		...
		/*======================================================================*//**
		 * <p>LoadChildAtAbove インスタンスのコピーを作成して、各プロパティの値を元のプロパティの値と一致するように設定します。</p>
		 * <p>Duplicates an instance of an LoadChildAtAbove subclass.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 * @return
		 * 	<p>元のオブジェクトと同じプロパティ値を含む新しい LoadChildAtAbove インスタンスです。</p>
		 * 	<p>A new LoadChildAtAbove object that is identical to the original.</p>
		 */
