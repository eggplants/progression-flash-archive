...
package jp.progression.core.components.loader {
	...
	public class LoaderComp extends CoreComp {
		...
		/*======================================================================*//**
		 * <p>読み込む XML ファイルの URL を取得または設定します。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		...
		/*======================================================================*//**
		 * <p>コマンド処理を実行中に lock プロパティの値を自動的に有効化するかどうかを取得または設定します。
		...
		/*======================================================================*//**
		 * <p>デバッグ出力機能を使用するかどうかを取得または設定します。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		...
		/*======================================================================*//**
		 * <p>Flash Player またはブラウザでのステージの配置を指定する StageAlign クラスの値を取得または設定します。</p>
		...
		/*======================================================================*//**
		 * <p>Flash Player が使用するレンダリング品質を指定する StageQuality クラスの値を取得または設定します。</p>
		...
		/*======================================================================*//**
		 * <p>使用する拡大 / 縮小モードを指定する StageScaleMode クラスの値を取得または設定します。</p>
