...
package jp.progression.core.components.effects {
	...
	public class EffectComp extends CoreComp {
		...
		/*======================================================================*//**
		 * <p>コンポーネントとして適用する EffectBase インスタンスを取得します。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		...
		public function get duration():int { return _component.duration; }
		public function set duration( value:int ):void { _component.duration = value; }
