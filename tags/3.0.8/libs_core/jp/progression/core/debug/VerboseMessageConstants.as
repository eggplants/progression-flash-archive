...
package jp.progression.core.debug {
	...
	/*======================================================================*//**
	 * <p>VerboseMessageConstants クラスは、デバッグ用メッセージを管理するモデルクラスです。
	 * VerboseMessageConstants クラスを直接インスタンス化することはできません。
	 * new VerboseMessageConstants() コンストラクタを呼び出すと、ArgumentError 例外がスローされます。</p>
	 * <p></p>
	 * 
	 * @langversion 3.0
	...
	public class VerboseMessageConstants {
		...
		private static var _initialized:Boolean = function():Boolean {
			...
			Locale.setString( "VERBOSE_0016", "ja", "<%0 : %1> コマンドを中断。" );
