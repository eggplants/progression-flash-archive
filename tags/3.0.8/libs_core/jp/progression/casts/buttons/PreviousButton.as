...
package jp.progression.casts.buttons {
	...
	/*======================================================================*//**
	 * <p>PreviousButton クラスは、ポインティングデバイスの状態に応じたタイムラインアニメーションを再生させるボタンコンポーネントクラスです。</p>
	 * <p></p>
	 * 
	 * @langversion 3.0
	...
	public class PreviousButton extends ButtonBase {
		...
		/*======================================================================*//**
		 * <p>前のシーンが存在しない場合に、一番後方のシーンに移動するかどうかを取得または設定します。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		...
		/*======================================================================*//**
		 * <p>新しい PreviousButton インスタンスを作成します。</p>
		 * <p>Creates a new PreviousButton object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		...
		private function _processScene( e:ProcessEvent ):void {
			...
			// 移動先を指定する
			super.sceneId = previous.sceneId.clone();
			
			// 次のシーンが現在のシーンと同じであれば無効化する
			buttonEnabled = !( previous == current );
		}
