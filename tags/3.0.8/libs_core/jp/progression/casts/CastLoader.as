...
package jp.progression.casts {
	...
	/*======================================================================*//**
	 * <p>CastLoader クラスは、ExLoader クラスの基本機能を拡張し、イベントフローとの連携機能を実装した jp.progression パッケージで使用される基本的な表示オブジェクトクラスです。</p>
	 * <p></p>
	 * 
	 * @langversion 3.0
	 * @playerversion Flash 9.0.45.0
	...
	public class CastLoader extends ExLoader implements ICastObject {
		...
		/*======================================================================*//**
		 * <p>新しい CastLoader インスタンスを作成します。</p>
		 * <p>Creates a new CastLoader object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		...
		/*======================================================================*//**
		 * <p>SWF、JPEG、プログレッシブ JPEG、非アニメーション GIF、または PNG ファイルを、この Loader オブジェクトの子であるオブジェクトにロードします。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
