...
package jp.nium.core.display {
	...
	/*======================================================================*//**
	 * <p>ExDisplayObject クラスは、IExDisplayObject インターフェイスを実装した DisplayObject クラスの基本機能を拡張するための委譲クラスです。
	 * このクラスを実装すると拡張されたイベント機能を持つ EventIntegrator クラスが Mix-in されることになります。</p>
	 * <p></p>
	 * 
	 * @langversion 3.0
	...
	public class ExDisplayObject implements IExDisplayObject {
		...
		/*======================================================================*//**
		 * <p>IExDisplayObject インターフェイスを実装した操作対象インスタンスです。</p>
		 * <p></p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		...
		/*======================================================================*//**
		 * <p>新しい ExDisplayObject インスタンスを作成します。</p>
		 * <p>Creates a new ExDisplayObject object.</p>
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 9.0.45.0
		 * 
		 * @param target
		 * 	<p>関連付けたい IExDisplayObject インターフェイスを実装したインスタンスです。</p>
		 * 	<p></p>
		 */
